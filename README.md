...
<br>
四種方法之間，就 Ｂ 圖片的結果來說， ORB extractor 的效果比較好，圖片的扭曲比較少，其他方法可能是連結到了錯誤的門，導致圖片最後都大扭曲。而 SIFT extractor 在加上 FLANN 之後，效果有變得比較好，比較不會有扭曲的情況，並且他在產生的速度上也比較快<br>
而 Ａ 圖片看來， SIFT_FLANN 的結果好像比較優，走廊地面的部分 ORB 看起來歪來歪去的，SIFT+FLANN  在窗戶地方的對齊也做得比較好。<br>
